export function Maintenance() {
  return (
    <div className="flex flex-col p-10 text-center h-[calc(100vh-6.25rem)] w-screen bg-gray-200">
      ...
      <p className="text-lg text-blue-900 mb-8">Hello, this section is currently undergoing maintenance. 
  ...
  return (
    <div className="flex flex-col p-10 text-center h-[calc(100vh-6.25rem)] w-screen bg-gray-200">
      ...
      <p className="text-lg text-blue-900 mb-8">You must be signed in to access this section. 
        Please 
        <a href="/client/sign-in" className="text-blue-500 hover:underline"> sign in </a> 
        or 
        <a href="/client/create-account" className="text-blue-500 hover:underline"> create an account. </a>
        </p>
      <a href="/" className="text-blue-500 hover:underline">Return to Home</a>
    </div>
  );
