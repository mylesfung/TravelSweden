  ...
  return (
    <div id="journal">
        <a href="#" className="block opacity-90 max-w-sm p-7 bg-sky-700 border border-gray-300 rounded-sm shadow">
          ...
          <a href="/pages/ReviewsPage" className="inline-flex items-center mt-5 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Create Entry
