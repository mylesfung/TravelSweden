...
function ReviewsWidget() {
    return (
        <div id="reviews">
            <a href="/pages/Reviews" className="block opacity-90 max-w-xs p-7 bg-sky-700 border border-gray-300 rounded-sm shadow">
                <h6 className="mb-2 text-2xl font-bold tracking-tight text-white dark:text-white">Reviews</h6>
                <p className="font-normal text-white dark:text-gray-400">User-averaged reviews of various travel destinations.</p>
