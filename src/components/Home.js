function Home() {
  return (
    <div class="flex flex-wrap w-full h-screen bg-stockholm gap-10 p-10">
      <div id="reviews">
        <a href="/pages/ReviewsPage" class="block opacity-90 max-w-xs p-7 bg-sky-700 border border-gray-300 rounded-sm shadow hover:bg-sky-800 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
